export const resumeData = {
    ...
    achievements: [
        ...
        },
        {
            ...
            description: "Directed the launch of two new product lines, achieving a 40% growth in market share."
        }
    ],
    experience: [
        {
    ...
    skills: [
        ["Strategic Planning", "Lean Manufacturing", "Process Optimization", "Team Leadership"],
        ["Contract Negotiation", "Product Development", "Sustainability Initiatives"],
        ["Supply Chain Management", "Risk Management", "Technology Integration"]
    ],
    certifications: [
        {
            title: "Lean Manufacturing Certification",
            description: "Focused on waste reduction and process efficiency. Provided by the Lean Enterprise Institute."
        },
        {
            title: "Advanced Project Management",
            description: "Covering strategic planning and execution, offered by the Project Management Institute."
        }
    ],
    passions: [
        {
